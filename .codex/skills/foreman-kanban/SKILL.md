---
name: foreman-kanban
description: Use when running inside Foreman (the FOREMAN env var is 1) and Codex needs to coordinate work through the project's kanban board — picking up a card, creating cards, editing title/body, closing out with done/block, or waiting on workers.
---
