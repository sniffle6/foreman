---
name: foreman-icat
description: Use when running inside Foreman (the FOREMAN env var is 1) and a Codex agent wants to show an image to the human — display a screenshot, render a PNG in the terminal, share visual evidence (a chart, a UI capture, a diff image) directly in your pane instead of just naming a file path.
---
