...
The landing page (shown by default when no project is *visible* — none open,
or every project minimized; `FOREMAN_NO_LANDING=1` disables it and restores
auto-open-in-cwd + quit-on-last-close) keeps a short list of the
