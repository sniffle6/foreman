---
name: foreman-kanban
description: Use when running inside foreman (the FOREMAN env var is 1) and coordinating work through the project's kanban board — picking up a card, dispatching a worker onto a card, creating cards, editing title/body, ordering cards into plans and waves, closing out with done/block, or waiting on workers.
---
