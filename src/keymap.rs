...
impl Command {
    ...
    pub fn label(self) -> &'static str {
        ...
        match self {
            ...
            ProjSnap(d) => match d {
                Dir::Left => "Move project left",
                Dir::Down => "Move project down",
                Dir::Up => "Move project up",
                Dir::Right => "Move project right",
            },
            ...
            TermSnap(d) => match d {
                Dir::Left => "Move terminal left",
                Dir::Down => "Move terminal down",
                Dir::Up => "Move terminal up",
                Dir::Right => "Move terminal right",
            },
            Split(d) => match d {
